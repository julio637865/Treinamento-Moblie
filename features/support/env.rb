...
Appium.promote_appium_methods Object #--> Invocando esse metodo eu acesso todos os modulos do appium de maneira nativa não sendo necessario escrever  o "driver" na frente do "find_element"
